...
public class QuestionServiceImpl extends BaseServiceImpl<Question> implements QuestionService {
    ...
    @Override
    public List<Question> selectQuestionByRand(Integer subjectId,Integer questionCount) {
        //todo  先去写mapper回来在接着写这里
/*        Integer maxid = questionMapper.selectMaxId();
        Integer minid = questionMapper.selectMinId();*/
        //获取0到1之间的随机数
        List<Question> questions = questionMapper.selectQuestionByRand(subjectId,questionCount);
        return questions;
    }
